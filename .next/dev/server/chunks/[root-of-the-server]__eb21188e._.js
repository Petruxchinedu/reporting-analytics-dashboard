...
async function handler(req, res) {
    ...
    if (req.method === "GET") {
        ...
        const reports = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Report$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["default"].find(filter).sort({
            createdAt: -1
        }).lean();
    ...
    if (req.method === "POST") {
        ...
        try {
            ...
            const newReport = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Report$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["default"].create({
                userId: dbUser._id.toString(),
                name,
                status: "Pending",
                date: new Date()
...
//# sourceMappingURL=%5Broot-of-the-server%5D__eb21188e._.js.map