...
"[project]/pages/api/reports/[id].ts [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function handler(req, res) {
    ...
    // Verify ownership
    const report = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Report$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["default"].findOne({
        _id: id,
        userId
    });
    ...
    if (req.method === "PATCH") {
        ...
        const updatedReport = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Report$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["default"].findByIdAndUpdate(id, {
            $set: {
                ...name && {
                    name
                },
    ...
    if (req.method === "DELETE") {
        await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Report$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["default"].findByIdAndDelete(id);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0e14f8bb._.js.map